...
setwd('/Users/alexis/IEHS Dropbox/Rager Lab/Alexis_Payton/2_Wildfire_Analysis/1_DeSeq2/1_miRNA_Mice_Plasma/1_Input')
getwd()

# Create an output folder (make sure to make the folder first, and then point to it here)
Output <- "/Users/alexis/IEHS Dropbox/Rager Lab/Alexis_Payton/2_Wildfire_Analysis/1_DeSeq2/1_miRNA_Mice_Plasma/2_Output"
Output_StatResults = "/Users/alexis/IEHS Dropbox/Rager Lab/Alexis_Payton/2_Wildfire_Analysis/1_DeSeq2/1_miRNA_Mice_Plasma/2_Output/1_StatResults"
cur_date = "010821"
